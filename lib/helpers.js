...
export function allowFingerprints(fingerprints) {
    ...
    // Stryker disable next-line MethodExpression,Regex,StringLiteral: normalization consistent on both sides of comparison; toUpperCase/toLowerCase, anchor, and replacement all equivalent
...
export function allowSerial(serials) {
    ...
    // Stryker disable next-line MethodExpression,StringLiteral: normalization consistent on both sides of comparison
