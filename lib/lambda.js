...
/**
 * @typedef {'lambda_event_missing_clientcert' | 'lambda_event_clientcert_malformed'} LambdaExtractionFailureReason
 */

/**
 * @typedef {Object} LambdaExtractionSuccess
 * @property {true} success - Always true on this arm of the union
 * @property {import('tls').PeerCertificate} certificate - Extracted certificate
 * @property {null} reason - Always null on this arm of the union
 */

/**
 * @typedef {Object} LambdaExtractionFailure
 ...
 * @property {LambdaExtractionFailureReason} reason - Rejection reason code
 *
 * Rejection reasons:
 * - 'lambda_event_missing_clientcert' - Event carried no clientCert under either payload shape
 * - 'lambda_event_clientcert_malformed' - clientCert was present but its PEM did not parse
 */

/**
 * @typedef {LambdaExtractionSuccess | LambdaExtractionFailure} LambdaExtractionResult
 */
 ...
 * @returns {LambdaExtractionResult}
 *
 * Rejection reasons:
